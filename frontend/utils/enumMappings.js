...
export const getAcademicYearEnum = (label) =>
  AcademicYearReverseMap[label] || label;
...
export const getDepartmentEnum = (label) =>
  DepartmentReverseMap[label] || label;

export const getOutpassStatusLabel = (value) =>
  OutpassStatusMap[value] || value;
export const getOutpassStatusColor = (value) =>
  OutpassStatusColors[value] || '#000';

export const getEmergencyTypeLabel = (value) =>
  EmergencyTypeMap[value] || value;
export const getEmergencyStatusLabel = (value) =>
  EmergencyStatusMap[value] || value;
export const getEmergencyPriorityLabel = (value) =>
  EmergencyPriorityMap[value] || value;
