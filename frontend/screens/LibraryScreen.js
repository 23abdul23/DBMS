...
export default function LibraryScreen({ navigation }) {
  ...
  const libraryClosesAt =
    libraryStatus?.closesAt || overview?.meta?.closesAt || '11:30 PM';
  const isLibraryOpenNow =
    libraryStatus?.status ?? overview?.meta?.isOpenNow ?? false;
          ...
          <View style={{ paddingHorizontal: 18, paddingTop: 18 }}>
            ...
            >
                ...
                >
                  <View
                    style={{
                      ...
                      height: '100%',
                      backgroundColor:
                        occupiedPercent >= 90 ? colors.warning : colors.primary,
                    }}
                  />
                </View>
              </View>
              ...
              >
                ...
                >
                  You can still see occupancy and your current token status
                  here.
                </Text>
              </View>
            </View>
            ...
            >
              ...
              {activityFeed.length ? (
                activityFeed
                  .filter(
                    (activity) => activity.type !== 'library_seat_released'
                  )
                  .map((activity, index) => (
                    <View
                      ...
                      style={{
                        ...
                        paddingVertical: 10,
                        borderBottomWidth:
                          index === activityFeed.length - 1 ? 0 : 1,
                    ...
                    >
                      <View
                        style={{
                          ...
                          justifyContent: 'center',
                          backgroundColor:
                            activity.type === 'library_seat_released'
                              ? colors.successSoft
                              : colors.primarySoft,
                          marginRight: 12,
                        }}
