...
export const SAC_EQUIPMENT = [
  { name: 'Table Tennis', icon: 'tennisball' },
  { name: 'Tennis', icon: 'tennisball-outline' },
  { name: 'Carrom', icon: 'grid-outline' },
  { name: 'Billiards', icon: 'ellipse-outline' },
  { name: 'Cricket', icon: 'american-football-outline' },
  { name: 'Squash', icon: 'flash-outline' },
